...
const Hodl = ({ fetchHodlData }) => {
  ...
  return (
    <div className=" mx-auto w-full lg:w-1/3 bg-white shadow-lg px-1 sm:px-5 py-5 mt-10 rounded-md font-sans">
      <div className="flex w-full items-center justify-between p-3">
        <Label className="text-lg font-bold text-slate-700">Hodl</Label>
        <Icon icon={FiSettings} className="xl" />
      </div>

      <div className="grid grid-cols-2 border-2 border-gray-300 py-3 rounded-lg mt-3 px-5 text-sm">
        <Input
          label={'Lock Amount'}
          type={'number'}
          id={'hodlAmount'}
